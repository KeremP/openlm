...
export function handleSelectModel(modelState: any, modelsStateContext: any, setModelsStateContext: any, parametersContext: any, setParametersContext: any, multi_select: boolean) {
  const number_of_models_selected = modelsStateContext.filter((modelState: { selected: any }) => modelState.selected).length
